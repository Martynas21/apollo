...
//! management (remove/reorder/clear), YouTube search/add-to-queue, and
//! saved-playlist listing/play, all for whichever guild the dashboard's
//! server switcher has selected.
